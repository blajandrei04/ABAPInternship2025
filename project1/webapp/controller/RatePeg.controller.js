sap.ui.define([
  ...
  return BaseController.extend("project1.controller.RatePeg", {
    ...
    fmtShowSave: function (status, su) {

      // su poate fi boolean sau string ("TRUE"/"X"/"true")

      var isManager = (su === true) || (su === "TRUE") || (su === "true") || (su === "X");

      return status === "PENDING" && isManager;

    },
 
    fmtEditable: function (status, su) {
